...
{
    public class Fireball : IProjectileEntity
    {
        ...
        public Fireball(float x, float y, int damage, Direction direction, float speed, IOwnerIdentifier ownerIdentifier)
        {
        ...
        public Fireball(float x, float y, Direction direction, IOwnerIdentifier ownerIdentifier)
        {
            PositionComponent = new PositionComponent(x, y);
